					...
					<form method="post" id="insert_form">
						<div class="table-repsonsive">
							...
							<div class="container m-1">
								...
								<select name="branch_id" class="p-2 col col-sm-2 form-control selectpicker branch_id" id="branch_id" disabled><option value="">Select Supplier</option><?php echo fill_unit_select_box_branch($connect, $branchid); ?></select>
							</div>
							<div class="container m-1">

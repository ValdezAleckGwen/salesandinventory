...
if (isset($_POST['source_branch'])) {
	...
	$output = '';
			...
			$inventories = $stmt->fetchAll(PDO::FETCH_ASSOC);
				...
				$output .= '<td width="14.6%"><select name="item_id[]" class="col col-sm-2 form-control selectpicker item_id" data-live-search="true"><option value="">Select Product</option>';
